...
//       const inputData = await fundingModel.getSessionInputData(sessionId);
//       console.log('Input Data:', inputData);

//       if (!inputData) {
//         return res.status(404).json({ error: 'No input data found for this session' });
//       }

//       const { salesForecasts, capitalCosts, payrollData, fixedExpenses } = inputData;

//       const calculations = await fundingCalc.runCalculations(sessionId, salesForecasts, capitalCosts, payrollData, fixedExpenses);
